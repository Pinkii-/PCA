...
/* mario: OR MAYBE YES WE WANT, WHO KNOWS */
...
//FFTW3
extern void discretise_structure( struct Structure This_Structure , float grid_span , int grid_size , double *grid ) ;

//FFTW2
//extern void surface_grid( float grid_span , int grid_size , fftw_real *grid , float surface , float internal_value ) ;

//FFTW3
extern void surface_grid( float grid_span , int grid_size , double *grid , float surface , float internal_value ) ;
...
//FFTW3
extern void electric_field( struct Structure This_Structure , float grid_span , int grid_size , double *grid ) ;
...
//FFTW3
extern void electric_point_charge( struct Structure This_Structure , float grid_span , int grid_size , double *grid ) ;

//FFTW2 
//extern void electric_field_zero_core( int grid_size , fftw_real *elec_grid , fftw_real *surface_grid , float internal_value ) ;

//FFTW3
extern void electric_field_zero_core( int grid_size , double *elec_grid , double *surface_grid , float internal_value ) ;
